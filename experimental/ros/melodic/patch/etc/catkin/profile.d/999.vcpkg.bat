...
set VCPKG_ROOT=c:\opt\ros\melodic\x64\tools\vcpkg
set VCPKG_DEFAULT_TRIPLET=x64-windows

:: add Vcpkg.exe to PATH
set PATH=%PATH:C:\opt\ros\melodic\x64\tools\vcpkg;=%
set "PATH=C:\opt\ros\melodic\x64\tools\vcpkg;%PATH%"
...
set "CMAKE_PREFIX_PATH=C:\opt\ros\melodic\x64\tools\vcpkg\installed\x64-windows;%CMAKE_PREFIX_PATH%"
